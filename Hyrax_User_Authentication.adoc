...
:leveloffset: +4
[[obtain-app-creds]]
include::Hyrax_Obtain_Earthdata_Login_Credentials.adoc[lines="1,8..-1"]

:leveloffset: 0
===== Compute the Authorization Code (`<URSClientAuthCode>`)

Before configuring _mod_auth_urs_, you must compute the authorization code
...
Hyrax offers a standalone implementation 
