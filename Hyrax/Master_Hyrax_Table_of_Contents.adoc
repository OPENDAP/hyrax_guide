...
:numbered:
:toc: left
:icons: font // show the icons in the admonition text (must be here)
:tabsize: 4
:indent: 4
:doctype: book
:source-highlighter: coderay
:coderay-linenums-mode: inline // add 'linenums' to [source, ...]
:prewrap!:	// Disable line wrapping in litteral blocks. jhrg 9/17/17
