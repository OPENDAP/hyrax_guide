...
NOTE: In practice, Hyrax is often used with data that have global
  extent, which corresponds to the SRS _WGS84_ (aka _EPSG 4326). The
...
+
Which can be read as _"Anything that starts with `/testbed-13/M2SDNXSLV.5.12.4/` "
...
In which the remote Hyrax requires authentication in order for clients to be granted access to metadata and/or data.
