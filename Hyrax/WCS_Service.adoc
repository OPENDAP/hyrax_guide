...
interpret the value as a URL pointing to a Hyrax server and will proceed to utilize the remote server to
fufill metadata and data requests required to perform the WCS activities.
