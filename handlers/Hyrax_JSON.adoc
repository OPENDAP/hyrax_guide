...
The JSON encoding utilizes an "instance" representation model wherein
...
Javascript variable names. Because of this second representation
probably doesn't have the required flexibility to become an official
JSON representation for the DAP.

The intention is to develop this work into a DAP4 extension that defines the JSON
