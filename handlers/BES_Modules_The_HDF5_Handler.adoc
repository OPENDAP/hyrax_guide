...
[width="100%",cols="33%,33%,34%",options="header",stripes=even]
|=======================================================================
...
|Compound |Structure 
a|
HDF5 compound variable can be mapped to DAP4 under the
...
[width="100%",cols="30%,30%,40%",options="header",stripes=even]
|=======================================================================
|HDF5 data type |DAP2 data name |Notes
|8-bit unsigned integer |Byte |
...
|64-bit unsigned integer |Not Supported 
a|
DAP2 does not support 64-bit unsigned integer type.

|64-bit signed integer |Not Supported 
a|
...
|Compound |Structure 
a|
HDF5 compound variable can be mapped to DAP2 under the
condition that the base members (excluding object/region references) of
