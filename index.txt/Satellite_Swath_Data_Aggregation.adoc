...
[[firstHeading]]
Satellite Swath Data Aggregation
--------------------------------
...
* link:#Notes[11 Notes]
** link:#Information_about_the_data[11.1 Information about the data]
** link:#Technical_approaches_to_the_problem[11.2 Technical approaches
to the problem]
*** link:#Using_the_BES_define_command[11.2.1 Using the BES define
command]
*** link:#Using_a_server_function[11.2.2 Using a server function]
**** link:#The_server_function_interface[11.2.2.1 The server function
interface]
***** link:#Specification_of_the_granules[11.2.2.1.1 Specification of
the granules]
***** link:#Variables_to_include_in_the_response[11.2.2.1.2 Variables to
include in the response]
***** link:#Space_and_Time_constraints[11.2.2.1.3 Space and Time
constraints]
**** link:#Response_Structure[11.2.2.2 Response Structure]
...
11.1 Information about the data
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
11.2 Technical approaches to the problem
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
11.2.1 Using the BES define command
+++++++++++++++++++++++++++++++++++
...
11.2.2 Using a server function
++++++++++++++++++++++++++++++
...
11.2.2.1 The server function interface
...
11.2.2.1.1 Specification of the granules
...
11.2.2.1.2 Variables to include in the response
...
11.2.2.1.3 Space and Time constraints
