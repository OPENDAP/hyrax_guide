...
* link:#Terms[2 Terms]
* link:#Apache_httpd_Authentication_Services_Configuration[3 Apache
_httpd_ Authentication Services Configuration]
** #First:_Configure_Apache_httpd_and_Tomcat_to_work_together[3.1 First:
Configure Apache httpd and Tomcat to work together]
*** link:#Configure_Apache[3.1.1 Configure Apache]
*** link:#Taking_advantage_of_Apache_Logging[3.1.2 Taking advantage of
Apache Logging]
*** link:#Add_SSL_Capabilities_to_Apache[3.1.3 Add SSL Capabilities to
Apache]
*** link:#Configure_Tomcat_.28Hyrax.29[3.1.4 Configure Tomcat (Hyrax)]
** #Second:_Configure_Apache_httpd_to_authenticate[3.2 Second: Configure
Apache httpd to authenticate]
*** link:#LDAP_.28mod_ldap.2C_mod_authnz_ldap.29[3.2.1 LDAP (mod_ldap,
mod_authnz_ldap)]
**** link:#LDAP_Authorization_Constraints[3.2.1.1 LDAP Authorization
Constraints]
*** link:#Shibboleth_.28mod_shib.29[3.2.2 Shibboleth (mod_shib)]
**** link:#Installation[3.2.2.1 Installation]
**** link:#Configuration[3.2.2.2 Configuration]
*** link:#URS_OAuth2_.28mod_auth_urs.29[3.2.3 URS OAuth2 (mod_auth_urs)]
**** link:#Prerequisites_.26_Requirements[3.2.3.1 Prerequisites &
Requirements]
**** link:#Building_mod_auth_urs[3.2.3.2 Building mod_auth_urs]
**** link:#Obtain_URS_Application_Credentials[3.2.3.3 Obtain URS
Application Credentials]
**** link:#Approve_your_URS_Application[3.2.3.4 Approve your URS
Application]
**** link:#Compute_the_Authorization_Code[3.2.3.5 Compute the
Authorization Code]
**** link:#Configuration_2[3.2.3.6 Configuration]
*** link:#Logging_URS_information[3.2.4 Logging URS information]
** link:#Common_Problems[3.3 Common Problems]
*** link:#Clients_keep_getting_Internal_Server_Error[3.3.1 Clients keep
getting *Internal Server Error*]
* link:#Tomcat_Authentication_Services_Configuration[4 Tomcat
Authentication Services Configuration]
** link:#LDAP[4.1 LDAP]
** link:#Shibboleth[4.2 Shibboleth]
** link:#URS_OAuth2[4.3 URS OAuth2]
...
3 Apache _httpd_ Authentication Services Configuration
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
3.1 First: Configure Apache httpd and Tomcat to work together
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
3.2.1.1 LDAP Authorization Constraints
...
3.2.3.1 Prerequisites & Requirements
...
3.2.3.3 Obtain URS Application Credentials
...
3.2.3.4 Approve your URS Application
...
3.2.3.5 Compute the Authorization Code
...
* Completed configuring link:../index.php/Hyrax_-_Apache_Integration[AJP
proxy for Tomcat]
