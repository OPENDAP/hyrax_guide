...
* link:#General_Questions_and_Assumptions[1 General Questions and
Assumptions]
* link:#How_to_flatten_hierarchical_types[2 How to flatten hierarchical
types]
** link:#Attributes_of_flattened_types.2Fvariables[2.1 Attributes of
flattened types/variables]
* link:#Extra_data_to_be_included[3 Extra data to be included]
* link:#Information_About_Specific_Types[4 Information About Specific
Types]
** link:#Strings[4.1 Strings]
** link:#Structures[4.2 Structures]
** link:#Grid[4.3 Grid]
** link:#Array[4.4 Array]
** link:#Sequences[4.5 Sequences]
** link:#Attributes[4.6 Attributes]
** link:#Added_attributes[4.7 Added attributes]
* link:#Support_for_CF[5 Support for CF]

1 General Questions and Assumptions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
2 How to flatten hierarchical types
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
2.1 Attributes of flattened types/variables
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
4 Information About Specific Types
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
