...
* link:#Access_Logging[1 Access Logging]
** link:#AccessLogValve[1.1 AccessLogValve]
* link:#Informational_and_Debug_Logging_.28Using_the_Logback_implementation_of_Log4j.29[2
Informational and Debug Logging (Using the Logback implementation of
Log4j)]
** link:#Configuration_File_Location[2.1 Configuration File Location]
...
*5.* Go read yer log files!
 ...
 +
 Of note is the _pattern_ attribute which allows you to customize the
...
2 Informational and Debug Logging (Using the Logback implementation of
Log4j)
-----------------------------------------------------------------------------
