...
handler will serve]
** link:#Mappings_between_NetCDF_version_4_data_model_and_DAP2_data_types[1.1
Mappings between NetCDF version 4 data model and DAP2 data types]
*** link:#Mappings_for_netCDF_4.27s_User_Defined_types[1.1.1 Mappings
for netCDF 4's User Defined types]
*** link:#NetCDF_4.27s_Group[1.1.2 NetCDF 4's Group]
* link:#Configuration_parameters[2 Configuration parameters]
** link:#IgnoreUnknownTypes[2.1 IgnoreUnknownTypes]
** link:#ShowSharedDimensions[2.2 ShowSharedDimensions]
** link:#PromoteByteToShort[2.3 PromoteByteToShort]
