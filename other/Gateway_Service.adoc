Gateway Service - OPeNDAP Documentation
=======================================
...
* link:#BES_gateway_module[2 BES gateway_module]
* link:#OLFS_gateway_service[3 OLFS gateway_service]
* link:#Encoding_data_source_URLs[4 Encoding data source URLs]
** link:#Prototype_Encoding[4.1 Prototype Encoding]
*** link:#Example_1[4.1.1 Example 1]
*** link:#Example_2[4.1.2 Example 2]
*** link:#Example_3[4.1.3 Example 3]

1 Overview
~~~~~~~~~~

../index.php/File:Gateway_service.jpg[image:../images/thumb/8/88/Gateway_service.jpg/180px-Gateway_service.jpg[Gateway
service.jpg]]

../index.php/File:Gateway_service.jpg[image:../skins/common/images/magnify-clip.png[image]]
