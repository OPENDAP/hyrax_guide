The FreeForm Data Handler - OPeNDAP Documentation
=================================================
...
** link:#Tasks_Illustrated_in_this_Guide[1.1 Tasks Illustrated in this
Guide]
*** link:#Serving_data_with_timestamps_in_the_file_names[1.1.1 Serving
data with timestamps in the file names]
** link:#Who_is_this_Guide_for.3F[1.2 Who is this Guide for?]
** link:#Organization_of_this_Document[1.3 Organization of this
Document]
...
1.1.1 Serving data with timestamps in the file names
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
