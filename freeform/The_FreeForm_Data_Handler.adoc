...
* <<dquick, Quick Start>>
* <<tblfmt, Serving tabular data>>
* <<arrayfmt, Array tabular data>>
* <<hdrfmts, Dealing with data file headers>>
* <<fileserv, Setup of File servers>>
...
== Freeform Data Handler Documentation
