...
include::./Hyrax_FreeForm_01_dintro.adoc[leveloffset=1]
include::./Hyrax_FreeForm_02_dquick.adoc[leveloffset=1]
include::./Hyrax_FreeForm_03_tblfmt.adoc[leveloffset=1]
include::./Hyrax_FreeForm_04_arrayfmt.adoc[leveloffset=1]
include::./Hyrax_FreeForm_05_hdrfmts.adoc[leveloffset=1]
include::./Hyrax_FreeForm_06_ff-server.adoc[leveloffset=1]
include::./Hyrax_FreeForm_07_fileserv.adoc[leveloffset=1]
include::./Hyrax_FreeForm_08_convs.adoc[leveloffset=1]
include::./Hyrax_FreeForm_09_fmtconv.adoc[leveloffset=1]
include::./Hyrax_FreeForm_10_datachk.adoc[leveloffset=1]
include::./Hyrax_FreeForm_A1_hdfutils.adoc[leveloffset=1]
include::./Hyrax_FreeForm_A2_errors.adoc[leveloffset=1]