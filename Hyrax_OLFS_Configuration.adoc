...
WARNING: There significant performance costs to utilizing the Timer.
...
The presence of this developer option in the configuration will cause the OLFS to preload
all of the NcML content found in the static THREDDS catalogs and attempt to transmit it to
the BES. There is at this time no software in the BEat can accept, store, or otherwise
utilize and respond to such a command  and so this should be considered a mothballed
feature.
