...
The most recent version of CentOS-7 (latest) has default SELinux settings that prohibit Tomcat from reading or opening the *opendap.war* file. This can be remediated by issuing the following two commands:
----
