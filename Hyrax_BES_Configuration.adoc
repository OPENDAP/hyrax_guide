...
[[site-conf-example-configuration0, site.conf Configuration Example: Using Hyrax to serve Data with Groups]]
=== _site.conf_ Configuration Example: Using Hyrax to serve that with Groups
